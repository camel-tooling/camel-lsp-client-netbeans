...
@OptionsPanelController.TopLevelRegistration(
        ...
        iconBase = "com/github/cameltooling/netbeans/client/icon32x32.png",
        keywords = "#OptionsCategory_Keywords_ApacheCamel",
        keywordsCategory = "ApacheCamel"
)
@org.openide.util.NbBundle.Messages({"OptionsCategory_Name_ApacheCamel=Apache Camel", "OptionsCategory_Keywords_ApacheCamel=apache, camel, language, support"})
